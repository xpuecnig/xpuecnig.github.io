...
(function (window) {
    ...
    var songs = {
        "Chen_Yixun-Fu_Kua": "陈奕迅-浮夸",
        "Chen_Yixun-Hong_Mei_Gui": "陈奕迅-红玫瑰",
        "Chen_Yixun-Shi_Nian": "陈奕迅-十年",
        "Chen_Yixun-Yin_Wei_Ai_Qing": "陈奕迅-因为爱情",
        "Jay_Chou-Fa_Ru_Xue": "周杰伦-发如雪",
        "Jay_Chou-Gao_Bai_Qi_Qiu": "周杰伦-告白气球",
        "Jay_Chou-Hua_Hai": "周杰伦-花海",
        "Jay_Chou-Hua_Sha": "周杰伦-画沙",
        "Jay_Chou-Jian_Dan_Ai": "周杰伦-简单爱",
        "Jay_Chou-Ni_Ting_De_Dao": "周杰伦-你听得到",
        "Jay_Chou-Pu_Gong_Ying_De_Yue_Ding": "周杰伦-蒲公英的约定",
        "Jay_Chou-Qi_Li_Xiang": "周杰伦-七里香",
        "Jay_Chou-Qian_Li_Zhi_Wai": "周杰伦-千里之外",
        "Jay_Chou-Qing_Hua_Ci": "周杰伦-青花瓷",
        "Jay_Chou-Shuo_Hao_De_Xing_Fu_Ne": "周杰伦-说好的幸福呢",
        "Jay_Chou-Ting_Ma_Ma_De_Hua": "周杰伦-听妈妈的话",
        "Jin_Nanling-Ni_Liu_Cheng_He": "金南玲-逆流成河",
        "Li_Yufen-Shi_Wo_Bu_Gou_Hao": "李毓芬-是我不够好",
        "Qi_Chen-Zan_Men_Ji_Hun_Ba": "齐晨-咱们结婚吧",
        "Ren_Yunqi-Wo_Shi_Sha_Gua": "任韵淇-我是傻瓜",
        "Ren_Yunqi-Zhi_Shao_Hai_You_Ni": "任韵淇-至少还有你",
        "Sun_Zihan-Quan_Shi_Jie_Xuan_Bu_Ai_Ni": "孙子涵-全世界宣布爱你",
        "Tian_Fuzhen-Xiao_Xing_Yun": "田馥甄-小幸运",
        "Tian_Fuzhen-Zhi_Dui_Ni_You_Gan_Jue": "田馥甄-只对你有感觉",
        "Tian_Fuzhen-Zhui_Meng_Ren": "田馥甄-追梦人",
        "Xia_Wanan-Du_Jiao_Xi": "夏婉安-独角戏",
        "Xia_Wanan-Fen_Shou_Ji": "夏婉安-分手季",
        "Xia_Wanan-Nao_Gou_Le_Mei_You": "夏婉安-闹够了没有",
        "Xia_Wanan-Yi_Ge_Ren": "夏婉安-一个人",
        "Xia_Wanan-Zhi_Bao_Bu_Zhu_Huo": "夏婉安-纸包不住火",
        "Xia_Wanan-Zhu_Lin_Fu_Qin": "夏婉安-竹林抚琴",
        "Xia_Wanan-Zui_Hou_De_Wan_An": "夏婉安-最后的晚安",
        "Xue_Ziqian-Yan_Yuan": "薛子谦-演员",
        "Zhu_Ya-Qian_Du": "朱雅-前度",
        "Zhuang_Xinyan-Yi_Wan_Ge_She_Bu_De": "庄心妍-一万个舍不得",
        "Zhuang_Xinyan-Zai_Jian_Zhi_Shi_Mo_Sheng_Ren": "庄心妍-再见只是陌生人"
    };
    ...
    function Turntable(el, options) {
        ...
        this.ctrls = {
            ...
            love: this.el.querySelector('.love-record > button.control-button--love'),
    ...
    Turntable.prototype._play = function (bufferOffset) {
        ...
        this.analyserTimeout = setTimeout(function () {
            self._analyse();
        }, bufferOffset && bufferOffset > 0 ? 0 : this.bufferDelay * 1000);
    ...
    Turntable.prototype._getSongName = function (url) {
        var songName = url.substring(4, url.indexOf('.mp3'));
    ...
    Turntable.prototype._initEvents = function () {
        ...
        this.ctrls.love.addEventListener('click', function () {
            self._navigate('next-page');
        });
    ...
    Turntable.prototype._navigate = function (direction) {
    ...
    Record.prototype.animate = function (direction, callback) {
        ...
        dynamics.animate(this.cover, transform[direction], {
            duration: duration, type: type, points: points, complete: function () {
    ...
    function RecordSlideshow(el, options) {
        ...
        this.ctrls = {
            ...
            love: this.el.querySelector('.controls__navigate > button.control-button--love'),
        ...
        dynamics.css(this.lpPlayCtrlPath, {
            strokeDasharray: this.lpPlayCtrlPathLen,
            strokeDashoffset: this.lpPlayCtrlPathLen
        });
            ...
            slideshow = new RecordSlideshow(document.querySelector('.view--single'), {
                ...
                onLoadRecord: function (record, progressEl, progressElLen) {
                    ...
                    turntable.loadRecord(record.info, function () {
                        ...
                        setTimeout(function () {
                            slideshow._showRecord();
                        }, 50);
                    }, function (progress) {
                        if (slideshow.isLoading) {
                            dynamics.animate(progressEl, {strokeDashoffset: progressElLen * ( 1 - progress / 100 )}, {
                                duration: 100,
                                type: dynamics.linear
                            });
                        }
